...
""",
    ...
    'data': [
        ...
        # 'views/efund_investor_views_old.xml',
        ...
        'views/efund_nav_session_view.xml',
        ...
        'views/efund_accounting_schema_new.xml',
        ...
        'data/efund_event_type_new.xml',
        'data/efund_event_amount_dispatcher.xml',
        'data/efund_account_schema_new.xml',
